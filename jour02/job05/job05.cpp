...
public:
    ...
    static std::shared_ptr<Pingouin> creer(const std::string& nom, double vNage, double vMarche, double vGlisse) {
        ...
        // Tri par temps de parcours (du plus rapide au plus lent)
    ...
    static void afficherTempsParcoursTous() {
        std::cout << "\n=== Temps de parcours de tous les pingouins (du plus rapide au plus lent) ===\n";
...
int main() {
    ...
    auto p3 = Pingouin::creer("Skipper", 2.5, 1.4, 3.2);
